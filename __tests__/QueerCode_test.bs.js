...
Jest.describe("QueerCode", (function (param) {
        Jest.Only[/* describe */4]("moduleArrayToRgbHex", (function (param) {
                return Jest.test("groups QR code into RGB triples", (function (param) {
                              var modules = qrCode.getModules();
                              return Jest.Expect[/* toEqual */12](rgbMatrix, Jest.Expect[/* expect */0](QueerCode$QueerLoop.moduleArrayToRgbHex(modules)));
                            }));
              }));
        return Jest.describe("rgbModules", (function (param) {
                      return Jest.test("turns modules into SVG", (function (param) {
                                    var modules = qrCode.getModules();
                                    var rgbModules = QueerCode$QueerLoop.moduleArrayToRgbHex(modules);
                                    return Jest.Expect[/* toEqual */12](queerCode, Jest.Expect[/* expect */0](QueerCode$QueerLoop.rgbModulesToSvgString(rgbModules)));
                                  }));
                    }));
      }));

exports.qrCode = qrCode;
exports.queerCode = queerCode;
exports.rgbMatrix = rgbMatrix;
